...
class Analyzer:
    ...
    def run_analyzer(self):
        ...
        results.compute_stats_AAAI()
        is_timeout = False
        if results.results_list[0].ver_output == Status.UNKNOWN:
            is_timeout = True
            print('Timeout!!')
        print('Results: ', results.output_count)
        print('Average time:', results.results_list[0].time)
        return results, is_timeout
