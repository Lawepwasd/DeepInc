...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        h = ["general"]
        self.add_argument("--random", type=float, default=None, choices=[0.001,0.01,0.03,0.05],
                          help='Random perturbation for acasxu.', hierarchy=h + ["random"])
        self.add_argument("--data", type=int, default=None, choices=[1,2,3,4,5],
                          help='Adv data for acasxu.', hierarchy=h + ["data"])
