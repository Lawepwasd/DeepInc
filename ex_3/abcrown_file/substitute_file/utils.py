...
def parse_run_mode():
    ...
    if arguments.Config["general"]["csv_name"] is not None and arguments.Config["specification"]["vnnlib_path"] is None:
        ...
        save_path = 'random_{}_data_{}_Verified_ret_[{}]_start={}_end={}_iter={}_b={}_timeout={}_branching={}-{}-{}_lra-init={}_lra={}_lrb={}_PGD={}_cplex_cuts={}_multiclass={}.npy'.format(
                   arguments.Config["general"]["random"],
                   arguments.Config["general"]["data"],
